...
def upgrade() -> None:
    op.drop_constraint("system_request_qos_rule_rule_uid_fkey", "system_request_qos_rule")
    op.drop_constraint("system_request_qos_rule_request_uid_fkey", "system_request_qos_rule")
