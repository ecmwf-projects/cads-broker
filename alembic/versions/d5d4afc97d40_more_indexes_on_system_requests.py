...
def upgrade() -> None:
    ...
    alembic.op.create_index("idx_system_requests_created_at", "system_requests", ["created_at"])
    alembic.op.create_index("idx_system_requests_finished_at", "system_requests", ["finished_at"])
